<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if (!empty($material) && !empty($quantity) && !empty($date)) {
            $q = "INSERT INTO outgoing (material, quantity, date) VALUES ('$material', '$quantity', '$date')";
...
<div class="container1">  
    ...
    <?php
      ...
      <tr>
        ...
        <td>      
        <div>
                  <a class='btn btn-success' href='oedit.php?id=$row[id]' >Edit</a>
                  <a class='btn btn-danger' href='odelete.php?id=$row[id]'>Delete</a>
                  </div>
                </td>
      </tr>
      ";
      ...
      <div class="container2">
        <button type="add" class="btn1" onclick="openPopup()">+ Add Outgoing</button>
      ...
      <div class="title">
        <h2>Outgoing Material</h2>
      </div>

      <div class="container4">
      <a class="btn3" href="o_excel.php">Export Excel</a>
      </div>

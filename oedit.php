<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == 'GET') {
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM outgoing WHERE id = $id";
    ...
    $sql = "UPDATE outgoing SET material=?, quantity=?, date=? WHERE id=?";
    $stmt = $con->prepare($sql);
    $stmt->bind_param("sssi", $material, $quantity, $date, $id);
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="card" style="margin-top: 90px;">
                <div class="card-header bg-dark">
                    <h1 class="text-white text-center">Update Outgoing</h1>
                </div><br>
                ...
                <a class="btn btn-info" href="incoming.php">Cancel</a>
            </div>
        </form>
    </div>

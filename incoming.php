<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if (!empty($material) && !empty($quantity) && !empty($date)) {
            $q = "INSERT INTO incoming (material, quantity, date) VALUES ('$material', '$quantity', '$date')";
...
<div class="container1">  
    ...
    <?php
      ...
      <tr>
        ...
        <td>      
        <div>
                  <a class='btn btn-success' href='iedit.php?id=$row[id]' >Edit</a>
                  <a class='btn btn-danger' href='idelete.php?id=$row[id]'>Delete</a>
                  </div>
                </td>
      </tr>
      ";
      ...
      <div class="container2">
        <button type="add" class="btn1" onclick="openPopup()">+ Add Incoming</button>
      ...
      <a class="btn3" href="i_excel.php">Export Excel</a>
      </div>
